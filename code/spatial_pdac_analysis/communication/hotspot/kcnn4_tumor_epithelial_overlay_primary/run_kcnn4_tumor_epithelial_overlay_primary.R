...
###############################################################################
# KCNN4 tumor epithelial signature overlay in primary PDAC sections
#
# Signature used here:
...
message("Computing section-wise overlap between KCNN4 and the tumor epithelial signature...")
...
pdf_path <- file.path(fig_dir, "tumor_epithelial_kcnn4_hotspot_vs_pathway_primary.pdf")
...
message("KCNN4 tumor epithelial overlay run complete.")
