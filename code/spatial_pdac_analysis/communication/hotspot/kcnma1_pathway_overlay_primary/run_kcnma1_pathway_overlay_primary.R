...
###############################################################################
# KCNMA1 pathway overlay in primary PDAC sections
#
# Goal:
#   Reproduce the logic used in the reference PDAC paper for pathway activity
#   maps, but focus on one question: with which continuous stromal program does
#   KCNMA1 spatially overlap in primary PDAC?
#
# Strategy:
...
PATHWAY_GENE_SETS <- list(
  Cancer_associated_fibroblasts = c(
    "ACTA2", "CD248", "COL11A1", "COL1A1", "COL1A2", "COL5A1", "COL6A1",
    "COL6A2", "COL6A3", "CXCL12", "FAP", "FBLN1", "FGF2", "FN1", "LRP1",
    "LUM", "MFAP5", "MMP2", "MMP3", "PDGFRA", "PDGFRB"
  ),
  Matrix = c(
    "COL11A1", "COL1A1", "COL1A2", "COL3A1", "COL4A1", "COL5A1", "ELN",
    "FN1", "LAMA3", "LAMB3", "LAMC2", "LGALS7", "LGALS9", "TNC", "VTN"
  ),
  Matrix_remodeling = c(
    "ADAMTS4", "ADAMTS5", "CA9", "LOX", "MMP1", "MMP11", "MMP12", "MMP2",
    "MMP3", "MMP7", "MMP9", "PLOD2"
  ),
  myCAF_contractile = c(
    "ACTA2", "TAGLN", "ACTG2", "MYL9", "CNN1", "DES", "PDLIM3", "THBS1",
    "CCN2", "COL12A1", "POSTN"
  ),
  NK_cells = c(
    "NKG7", "GNLY", "PRF1", "KLRD1", "CTSW", "XCL1", "XCL2", "FCGR3A",
    "TYROBP", "TRAC"
  )
)
